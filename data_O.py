...
def get_last_date_api():
    cur = mydb.cursor()
    cur.execute('SELECT date FROM monitor WHERE id_gedung = 3 ORDER BY id DESC LIMIT 1')
...
def Get_Data():
    ...
    device_token = "4cea9e8586c05273209ae1fd71049245"
    page = 0
    batas = False
