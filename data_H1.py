...
def get_last_date_api():
    cur = mydb.cursor()
    cur.execute('SELECT date FROM monitor WHERE id_gedung = 4 ORDER BY id DESC LIMIT 1')
...
def Get_Data():
    ...
    device_token = "4438ca6fc2a575cfab4fa4f1d4569964"
    page = 0
    batas = False
