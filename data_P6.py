...
def get_last_date_api():
    cur = mydb.cursor()
    cur.execute('SELECT date FROM monitor WHERE id_gedung = 1 ORDER BY id DESC LIMIT 1')
...
def Get_Data():
    ...
    device_token = "cea949ea3537bc59e96b3a8ce119dfc3"
    page = 0
    batas = False
